...
namespace R5T.F0052
{
	...
	{
		/// <summary>
		/// Determines if the project file path meets the requirements for being a project file path (i.e. ends with the <see cref="IFileExtensions.CSharpProjectFile"/> project file extension).
